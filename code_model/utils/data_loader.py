...
def build_loader(config):
	...
	elif config.data.dataset == 'MACE':
		root = os.path.join(config.data.data_root, 'MACE')
		train_set = MACEset(root, True, train_transform)
		test_set = MACEset(root, False, test_transform)
		num_classes = 2
